...
impl AuthenticatedEncryption {
    ...
    pub fn GenerateProof(&self, length: usize) -> Option<Vec<u8>> {
    ...
    pub fn ValidateProof(&self, proof: &[u8]) -> bool {
        unsafe {
...
impl ClientEasyHandshake {
    ...
    pub fn GenerateServerKey(&self) -> Option<([u8; PUBLIC_KEY_BYTES], [u8; PRIVATE_KEY_BYTES])> {
    ...
    pub fn Initialize(&self, public_key: &[u8; PUBLIC_KEY_BYTES]) -> bool {
    ...
    pub fn GenerateChallenge(&self) -> Option<[u8; CHALLENGE_BYTES]> {
    ...
    pub fn ProcessAnswer(&self, answer: &[u8; ANSWER_BYTES]) -> Option<AuthenticatedEncryption> {
